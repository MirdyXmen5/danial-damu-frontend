...
const Advantages = () => {
  ...
  const cards = [
    ...
    { id: 'card3', icon: Layers, color: 'text-brand-brightBlue', bg: 'bg-brand-bg-softBlue' },
  ...
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-brand-darkBlue mb-12">
          {t('advantages.title')}
        </h2>
